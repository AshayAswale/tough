...
const std::string LEFT_FOOT_SUPPORT_POLYGON_TOPIC = "/capturability/left_foot_support_polygon";
const std::string RIGHT_FOOT_SUPPORT_POLYGON_TOPIC = "/capturability/right_foot_support_polygon";
